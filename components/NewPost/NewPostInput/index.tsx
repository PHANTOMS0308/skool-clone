...
const NewPostInput: FC = () => {
  ...
  return (
    <div>
      {onEditing ? (
        <Card
          className={styles.NewPostInputCardEditing}
          data-testid="new-post-input-onEditing"
        >
          {/**
            ...
            <form>
              ...
              {uploadArr.length > 0 ? (
                <FileUploadContainer>
                  ...
                  <FileUploadPreview setUploadArr={setUploadArr} />
                </FileUploadContainer>
              ) : null}
              ...
              <div>
                <div className={styles.postToolContainer}>
                  <div
                    ...
                    data-testid="new-post-tools-container"
                  >
                    <NewPostTools
                      attachment={true}
                      link={true}
          ...
          <div className={styles.pickerContainer}>
            ...
            {isAddingGif ? (
              <>
                <div className={styles.gifPicker} data-testid="gif-container">
                  {"gifArr" in gifData && gifData.gifArr ? (
                    ...
                    <div
                      data-testid="gif-loading-container"
                      className={styles.gifLoadingContainer}
                    >
                      <CircularProgress />
                    </div>
                  )}
